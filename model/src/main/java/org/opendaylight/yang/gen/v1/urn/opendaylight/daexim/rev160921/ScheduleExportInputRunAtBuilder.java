 ...
 */
package org.opendaylight.yang.gen.v1.urn.opendaylight.daexim.rev160921;
 ...
 *
 */
public class ScheduleExportInputRunAtBuilder {

    public static RunAt getDefaultInstance(java.lang.String defaultValue) {
        try {
            return new RunAt(RelativeTime.getDefaultInstance(defaultValue));
        } catch (Exception e) {
            return new RunAt(new AbsoluteTime(defaultValue));
        }
    }
}
