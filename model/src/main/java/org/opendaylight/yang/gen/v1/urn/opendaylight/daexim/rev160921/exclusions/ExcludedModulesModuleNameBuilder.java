 ...
 */
package org.opendaylight.yang.gen.v1.urn.opendaylight.daexim.rev160921.exclusions;
 ...
 *
 */
public class ExcludedModulesModuleNameBuilder {
    public static final String STAR = "*";

    public static ModuleName getDefaultInstance(java.lang.String defaultValue) {
        if (STAR.equals(defaultValue)) {
            return new ModuleName(new WildcardStar(defaultValue));
        }
        return new ModuleName(new YangIdentifier(defaultValue));
    }
}
